...
class SoloTour extends Component{
            ...
            <div>
                <div>
                    <Breadcrumb>
                        ...
                        <BreadcrumbItem active>Solo Tour</BreadcrumbItem>
                    </Breadcrumb>
                </div>
                <div className="container">
                    <div className="row row-content">
                        <div className="col-12 headcss mb-5"> Explore Best Solo Tours! </div>
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-23.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-24.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-25.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-26.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-27.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-28.jpg" alt="Card image cap" />
                                <CardBody>
                                <CardTitle className="headcss1">Prague Trip</CardTitle>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-29.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-30.jpg" alt="Card image cap" />
                                <CardBody>
                        ...
                        <div className="col-12 col-md-6 col-xl-4">
                            <Card>
                                <CardImg className="cardimage" top width="100%" src="assets/images/pic-31.jpg" alt="Card image cap" />
                                <CardBody>
